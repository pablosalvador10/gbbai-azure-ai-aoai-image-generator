...
class AzureOpenAIManager:
    ...
    def __init__(
        ...
        :param vision_model_name: The Vision Model Deployment ID. If not provided, it will be fetched from the environment variable "AZURE_AOAI_VISION_MODEL_DEPLOYMENT_ID".
        ...
        self.vision_model_name = vision_model_name or os.getenv(
            "AZURE_AOAI_VISION_MODEL_DEPLOYMENT_ID"
        )
